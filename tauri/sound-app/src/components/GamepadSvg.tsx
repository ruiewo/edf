type GamepadSvgProps = {
  ...
  analogLeft: boolean
  analogRight: boolean
  analogLeftDirection: "up" | "down" | "left" | "right" | undefined
  analogRightDirection: "up" | "down" | "left" | "right" | undefined
  select: boolean
  start: boolean
  activeColor?: string
...
const createTransform = (direction: Direction) => {
  switch (direction) {
    case "up":
